...
struct target_desc *tdesc_vspa2;
static void
initialize_tdesc_vspa2 (void)
{
  struct target_desc *result = allocate_target_description ();
  struct tdesc_feature *feature;

  set_tdesc_architecture (result, bfd_scan_arch ("vspa2"));

  feature = tdesc_create_feature (result, "vspa2-core-regs");
